    ...
    <div className="border-t border-neutral-100">
      <div className="flex items-center justify-between py-7 border-b border-neutral-100">
        <div className="flex items-center gap-4">
          ...
          <span className="font-mono text-[11px] text-neutral-300">{SEED_AGENTS.length}</span>
        </div>
    ...
    <Link href={`/agents/${agentId}`}>
      <div className="group flex items-center gap-6 lg:gap-8 py-6 border-b border-neutral-100 hover:bg-neutral-50/50 transition-colors cursor-pointer">
        ...
        <div className="w-32 flex-shrink-0 min-w-0">
          <p className="font-mono text-[13px] text-neutral-800 tracking-[0.04em] truncate">{name}</p>
        ...
        <div className="flex items-baseline gap-2 w-24 flex-shrink-0">
          <span className="font-display font-light text-neutral-900 text-[1.6rem] leading-none">{score}</span>
          <span
        ...
        <div className="flex-1 min-w-0 hidden md:block">
          <p className="font-mono text-[10px] text-neutral-400 truncate">{network}</p>
        </div>
