...
export default function GraphPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 flex flex-col pt-24">

      {/* Header */}
      <div className="px-6 lg:px-14 py-12 border-b border-neutral-100 dark:border-neutral-800">
        <div className="flex items-start justify-between flex-wrap gap-8">
          <div>
            <div className="flex items-center gap-3 mb-5">
              <span style={{ color: '#4169e1' }} className="text-[13px] leading-none select-none">■</span>
              <span className="font-mono text-[12px] tracking-[0.26em] text-neutral-400 uppercase">Org Graph</span>
            </div>
            <h1
            ...
            <p className="font-mono text-[11px] text-neutral-400 tracking-[0.1em] mt-5 leading-relaxed">
...
function LegendItem({ color, label }: { color: string; label: string }) {
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="font-mono text-[11px] tracking-[0.12em] text-neutral-400">{label}</span>
    </div>
  )
}
